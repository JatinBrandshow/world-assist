                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                        ...
                        <div className="lg:col-span-8 space-y-8">
                            ...
                            <h3 className="text-3xl font-bold text-brand-black leading-snug">
                                "In world-class acquisitions, the best deals aren't found; they are negotiated through
                                transparency. We are the shield between your ambition and the market's hidden risks."
                            </h3>
